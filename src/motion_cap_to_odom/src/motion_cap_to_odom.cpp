...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber pose_sub = nh.subscribe("/vrpn_client_node/YZU0/0/pose", 1, POSEcallback);
    ros::Subscriber twist_sub = nh.subscribe("/vrpn_client_node/YZU0/0/velocity", 1, VELcallback);
