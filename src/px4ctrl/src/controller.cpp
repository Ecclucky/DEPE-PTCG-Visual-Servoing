...
double desire_v_y = 0;
double desire_v_z = 0;
const double position_controller_gain_horizontal = 0.9; // Horizontal position-loop proportional gain.
const double position_controller_gain_vertical = 1;     // Vertical position-loop proportional gain.
                                                             ...
                                                             Controller_Output_t &u, int state_count, bool in_landing_)
{
  ...
  // The attitude setpoint is expressed directly in the odometry world frame.
